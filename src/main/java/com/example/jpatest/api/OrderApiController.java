...
import com.example.jpatest.repository.order.query.OrderFlatDto;
import com.example.jpatest.repository.order.query.OrderItemQueryDto;
import com.example.jpatest.repository.order.query.OrderQueryDto;
import com.example.jpatest.repository.order.query.OrderQueryRepository;
import lombok.Data;
...
public class OrderApiController {
    ...
    /**
     * V1. 엔티티 직접 노출
     * -  Hibernate5Module 모듈 사용, LAZY=null 처리
